    ...
    return (
        ...
        <ol className="list-decimal pl-8 text-gray-300 mb-8">
          ...
          <li className="mb-6">
            ...
            <img className="w-[90%] lg:w-[70%] mt-4 rounded-lg shadow-md" src="/DashboardPage.png" alt="Dashboard Page" />
          </li>
          <li className="mb-6">
            <p className="mb-2 text-white">Enter Project Name</p>
            <p>Enter the project name and click <strong>Save</strong>.</p>
            <img className="w-[90%] lg:w-[70%] mt-4 rounded-lg shadow-md" src="/ProjectName.png" alt="Project Name" />
          </li>
          <li className="mb-6">
            ...
            <img className="w-[90%] lg:w-[70%] mt-4 rounded-lg shadow-md" src="/APIpage.png" alt="API Page" />
          </li>
          <li className="mb-6">
